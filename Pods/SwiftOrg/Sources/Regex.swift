...
public extension String {
    ...
    internal func match(_ regex: String, options: RegularExpression.Options = []) -> [String?]? {
    ...
    internal func matchSplit(_ regex: String, options: RegularExpression.Options) -> [String] {
        let expression = self.getExpression(regex, options: options)
    ...
    internal func tryMatch(_ regex: String,
